            ...
            return (
                ...
                <ScrollView>
                    <View style={styles.container}>
                        <Text style={[FBFont.AlternateGot(23), styles.heading]}>Relationship Details</Text>
                        ...
                        <View style={[styles.shadow,styles.card]}>
                            ...
                            <View style={styles.btnCancel}>
                                <Button_next text="Save" height={39} page={()=>this.jumpTo('MyRelationships')}/>
                            </View>
                            <View style={styles.btnNext}>
                                <Button_next text="Cancel" height={39} page={()=>this.jumpTo('MyRelationships')}/>
                            </View>
                        </View>
                        </View>
